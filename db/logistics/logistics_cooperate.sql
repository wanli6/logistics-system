...
CREATE TABLE `cooperate` (
  ...
  CONSTRAINT `fk_l_id` FOREIGN KEY (`l_id`) REFERENCES `logistics` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `fk_t_id` FOREIGN KEY (`t_id`) REFERENCES `trucks` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `cooperate` VALUES (1,201),(2,202),(1,203),(3,203),(4,204),(5,205),(1,210),(1,212),(1,213);
